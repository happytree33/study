			...
			<div class="result_lst">
				<ul class="rs_ul">
					<li class="rs_li">
						...
						<div class="info">
							<span class="dir"><a href="#" title="">
								<c:out value="${indexItemList.doc_box_name}" escapeXml="false" /></a>
							</span>	
							<span class="user">
...
<!-- 						<span class="date">
								<em><spring:message code="srch.text.writer" text=""  />:</em>
								<c:out value="${indexItemList.FIELD_REG_DATE}" escapeXml="false" />
							</span> -->
										...
										<c:forEach var="attachList"  items="${indexItemList.doc_files}" varStatus="attachListStatus"  >
											<li class="prvw_open">
												<div class="atch_info">
													...
													<a href="#">
														<c:out value="${attachList.file_real_name}" escapeXml="false"  />
													</a>
