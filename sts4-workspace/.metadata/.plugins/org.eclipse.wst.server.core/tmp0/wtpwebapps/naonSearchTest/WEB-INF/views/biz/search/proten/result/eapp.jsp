			...
			<div class="result_lst">
				<ul class="rs_ul">
					<li class="rs_li">
						...
						<div class="info">
							<span class="dir">
								<a href="#" class="ui"><c:out value="${indexItemList.doc_reg_dept_name}" escapeXml="false" /></a>
							</span>
							<span class="user">
							...
							<!-- <span class="date"><em>등록일:</em><c:out value="${indexItemList.FIELD_MOD_DATE}"  escapeXml="false" /></span> -->
