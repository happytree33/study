...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	<!-- 스마트워크 <spring:message code="srch.text.search.result" text=""  /> -->
...
<!-- 					<span class="date">
						...
						<span class="state">
							상태:<c:out value="${indexItemList.doc_reg_user_name}" escapeXml="false" />
						</span>
						<span class="prgs">
							진척도:<c:out value="${indexItemList.doc_reg_user_name}" escapeXml="false" />%
						</span>
					</div>
					<!-- 첨부파일 -->		
